class Grass extends Kendanieak {
    ...
    bazmanal() {
        ...
        if (this.multiply >= 10 && this.direction && weather == 1) {
        ...
        else if (this.multiply >= 1 && this.direction && (weather == 2 || weather == 3)) {
            var newGrass = new Grass(this.direction[0], this.direction[1], this.index);
            newGrass.parentX = this.x;
            newGrass.parentY = this.y;
            grassArr.push(newGrass);
        ...
        else if (this.multiply >= 5 && this.direction && weather == 4) {
            var newGrass = new Grass(this.direction[0], this.direction[1], this.index);
            newGrass.parentX = this.x;
            newGrass.parentY = this.y;
            grassArr.push(newGrass);
